        ...
        <main className="flex-1 overflow-hidden p-4 md:p-8">
          <div className="mx-auto grid h-full max-w-7xl grid-cols-1 gap-8 md:grid-cols-3">
            <div className="md:col-span-1">
              <Card className="flex h-full flex-col items-center justify-center border-0 bg-secondary/30 p-6 shadow-2xl">
            ...
            <div className="md:col-span-2">
              <Card className="h-full border-0 bg-secondary/30 shadow-2xl">
